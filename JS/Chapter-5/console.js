...
console.table(['Deepali', 'Ghadia']); // output will be printed with by-default index i.e. 0 and 1 (as list)
console.table({1: 'Deepali', 2: 'Ghadia'}); // output will be printed with the specified keys and corresponding values (dictionary)
